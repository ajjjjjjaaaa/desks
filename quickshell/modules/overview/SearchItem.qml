...
RippleButton {
    ...
    colBackground: (root.down || root.keyboardDown) ? Appearance.m3colors.m3layerBackground2 : ((root.hovered || root.focus) ? Appearance.m3colors.m3layerBackground3 : ColorUtils.transparentize(Appearance.m3colors.m3layerBackground3, 1))
