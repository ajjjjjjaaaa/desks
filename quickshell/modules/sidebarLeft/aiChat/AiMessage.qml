                ...
                RowLayout {
                    ...
                    Item {
                        ...
                        MaterialSymbol {
                            ...
                            color: Appearance.m3colors.m3colors.m3primaryText
        ...
        ColumnLayout { // Message content
            ...
            Repeater {
                ...
                delegate: Loader {
                    ...
                    source: thisBlock.type === "code" ? "MessageCodeBlock.qml" : thisBlock.type === "think" ? "MessageThinkBlock.qml" : "MessageTextBlock.qml"
                }
            }
        }
