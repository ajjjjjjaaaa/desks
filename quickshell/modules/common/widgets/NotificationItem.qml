...
Item { // Notification item area
    ...
    Rectangle { // Background of notification item
        ...
        color: (expanded && !onlyNotification) ? (notificationObject.urgency == NotificationUrgency.Critical) ? ColorUtils.mix(Appearance.m3colors.m3background, Appearance.m3colors.m3background, 0.35) : (Appearance.m3colors.m3background) : ColorUtils.transparentize(Appearance.m3colors.m3background)
