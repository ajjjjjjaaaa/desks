...
Rectangle { // App icon
    ...
    Loader {
        ...
        sourceComponent: MaterialSymbol {
            ...
            anchors.fill: parent
            color: (root.urgency == NotificationUrgency.Critical) ? ColorUtils.mix(Appearance.m3colors.m3onSecondary, Appearance.m3colors.m3onSecondaryContainer, 1) : Appearance.m3colors.m3onSecondaryContainer
